...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  document.getElementById("profileHeader").innerHTML = `
        ...
        <img src="${resolveDossierImageSrc(person.img) || PROFILE_PLACEHOLDER}" class="w-28 h-28 rounded-full object-cover p-2 transition-all duration-700 shadow-[0_0_30px_rgba(255,0,0,0.15)]" alt="${person.name}">
                </div>
