...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const studentsData = [
            ...
            { name: "Deepika V",              role: "Kalvian", bio: "B.Tech CSE Student | Aspiring Software Developer | Passionate About AI & Web Development | Learning, Building, Growing",                                                                        img: "./Src/Deepika (1).jpg", github: "https://github.com/deepikavs138-design",         linkedin: "https://www.linkedin.com/in/deepika-v-957099382", email: "deepika.v.s.138@kalvium.community" },
            { name: "HARICHARAN P",           role: "Kalvian", bio: "I’m Haricharan, a focused and determined individual who believes in constant growth.I adapt quickly to new challenges and strive to improve every day. With a positive mindset and strong work ethic, I aim to achieve success.",                                                                    img: "./Src/Hari charan (1).png", github: "https://github.com/harips138-droid",             linkedin: "https://www.linkedin.com/in/hari-charan-p-5006393b1", email: "hari.p.s.138@kalvium.community" },
    ...
    document.getElementById('searchBox').addEventListener('input', (e) => {
        ...
        const staticCards = document.querySelectorAll('#studentGrid .card-perspective, #mentorGrid .card-perspective');
